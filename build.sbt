...
libraryDependencies += "io.netty" % "netty-tcnative" % "1.1.33.Fork19" classifier "linux-x86_64"
libraryDependencies += "io.netty" % "netty-tcnative" % "1.1.33.Fork19" classifier "osx-x86_64"
libraryDependencies += "io.netty" % "netty-tcnative" % "1.1.33.Fork19" classifier "windows-x86_64"
...
dependencyOverrides += "org.webjars.bower" % "jquery" % "3.1.0"
