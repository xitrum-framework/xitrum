...
``fileUploadParams`` is of type scala.collection.mutable.Map[String, List[`FileUpload <http://netty.io/3.8/api/org/jboss/netty/handler/codec/http/multipart/FileUpload.html>`_]].
...
To send cookie to browser, create an instance of `DefaultCookie <http://netty.io/3.8/api/org/jboss/netty/handler/codec/http/DefaultCookie.html>`_
and append it to ``responseCookies``, an ``ArrayBuffer`` that contains `Cookie <http://netty.io/3.8/api/org/jboss/netty/handler/codec/http/Cookie.html>`_.
