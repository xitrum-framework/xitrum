...
/**
 * https://github.com/netty/netty/issues/2305
 *
 * This decoder will decode Body and can handle POST BODY.
 *
 * You <strong>MUST</strong> call {@link #destroy()} after completion to release all resources.
 */
public class HttpPostRequestDecoderWithFix2305 {
     ...
     *             errors
     */
    public HttpPostRequestDecoderWithFix2305(HttpRequest request) throws ErrorDataDecoderException,
     ...
     *             errors
     */
    public HttpPostRequestDecoderWithFix2305(HttpDataFactory factory, HttpRequest request) throws ErrorDataDecoderException,
            IncompatibleDataDecoderException {
     ...
     *             errors
     */
    public HttpPostRequestDecoderWithFix2305(HttpDataFactory factory, HttpRequest request, Charset charset)
     ...
     *             errors
     */
    public HttpPostRequestDecoderWithFix2305 offer(HttpContent content) throws ErrorDataDecoderException {
        checkDestroyed();
