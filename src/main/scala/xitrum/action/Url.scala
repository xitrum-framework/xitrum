...
object Url {
  /**
    * Ex: publicUrl("jquery/3.0.0/jquery.js")
    *
  ...
  /**
    * Ex: publicUrl("jquery/3.0.0/jquery.js", "jquery/3.0.0/jquery.min.js")
    *
  ...
  /**
    * Ex: publicUrl("jquery/3.0.0", "jquery.js", "jquery.min.js")
    *
  ...
  /**
    * Ex: webJarsUrl("jquery/3.0.0/jquery.js", "jquery/3.0.0/jquery.min.js")
    *
  ...
  /**
    * Ex: webJarsUrl("jquery/3.0.0", "jquery.js", "jquery.min.js")
    *
    * @param devFile File in the directory to use in development mode
    * @param prodFile File in the directory to use in production mode
    */
