...
trait JS {
  ...
  lazy val jsDefaults = {
    ...
    if (Config.productionMode)
      <xml:group>
        <script type="text/javascript" src={resourceUrl("xitrum/jquery-1.10.0.min.js")}></script>
      ...
      <xml:group>
        <script type="text/javascript" src={resourceUrl("xitrum/jquery-1.10.0.js")}></script>
