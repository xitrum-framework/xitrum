...
trait JsRenderer {
  ...
  lazy val jsDefaults = {
    ...
    val validateI18n = if (locale.getLanguage == "en") "" else (<script type="text/javascript" src={webJarsUrl(s"jquery-validation/1.18.0/src/localization/messages_${locale.toString}.js")}></script>)

    <xml:group>
      <script type="text/javascript" src={webJarsUrl("jquery/3.3.1/dist",             "jquery.js",             "jquery.min.js")}></script>
      <script type="text/javascript" src={webJarsUrl("jquery-validation/1.18.0/dist", "jquery.validate.js",    "jquery.validate.min.js")}></script>
      <script type="text/javascript" src={webJarsUrl("jquery-validation/1.18.0/dist", "additional-methods.js", "additional-methods.min.js")}></script>
      {validateI18n}
